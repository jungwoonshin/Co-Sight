...
def create_actor_instance(agent_instance_name, work_space_path):
    agent_params = {
        ...
        'template_version': 'v1',
        'display_name_zh': 'Task Execution Expert',
        'display_name_en': 'Task Execution Expert',
        'description_zh': 'Specialized assistant for task execution and operations',
...
def create_actor_template(template_name, work_space_path):
    template_content = {
        ...
        'display_name_zh': 'Task Execution Expert',
        'display_name_en': 'Task Execution Expert',
        'description_zh': 'Responsible for task execution',
        'description_en': 'Responsible for task execution',
        "profile": [],
        'service_name': 'execution_service',
        'service_version': 'v1',
        'default_replay_zh': 'Task Execution Expert',
