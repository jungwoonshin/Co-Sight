...
def create_planner_instance(agent_instance_name):
    agent_params = {
        ...
        'template_version': 'v1',
        'display_name_zh': 'Task Planning Expert',
        'display_name_en': 'Task Planning Expert',
        'description_zh': 'Specialized assistant for task decomposition and planning',
...
def create_planner_template(template_name):
    template_content = {
        ...
        'display_name_zh': 'Task Planning Expert',
        'display_name_en': 'Task Planning Expert',
        'description_zh': 'Responsible for task decomposition and planning',
        'description_en': 'Responsible for task decomposition and planning',
        "profile": [],
        'service_name': 'planning_service',
        'service_version': 'v1',
        'default_replay_zh': 'Task Planning Expert',
